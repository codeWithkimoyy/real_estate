...
import { Eye, EyeOff, Mail, Lock, ArrowRight, Sparkles, X, UserPlus } from 'lucide-react';
        ...
        <div className="relative z-10 flex flex-col justify-between p-12">
          ...
          <div className="login-image-text">
            ...
            <p className="text-gray-blue text-lg">
              Join thousands of Filipinos who found their perfect property with Brader Real Estate.
            </p>
          </div>
        </div>
      </div>
      ...
      {showRolePicker && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="relative w-full max-w-sm bg-[#0d1f35] border border-white/10 rounded-2xl p-6 shadow-2xl">
            ...
            <p className="text-gray-blue text-sm mb-5">How will you use Brader Real Estate?</p>
